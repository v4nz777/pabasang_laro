...
class Choice(MDFillRoundFlatIconButton):
    ...
    def on_release(self):
        self.exercise = self.parent.parent.parent.parent.parent.parent.parent.parent.parent
        ...
        if len(self.exercise.total_answers) == self.exercise.num_items:
            ...
            self.exercise.toolbar7.disabled = False
            ...
            self.dialog = MDDialog(
                ...
                buttons=[
                    ...
                    MDFlatButton(
                        ...
                        theme_text_color="Custom",
                        text_color=(0,0,1,1),
                        on_release=lambda x: self.manager.switch(f'Exercise{self.exercise_num+1}','left')
                    ),
                ],
            )
        self.dialog.open()
